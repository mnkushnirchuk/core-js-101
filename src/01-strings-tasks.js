...
/**
 * Returns the string representation of a rectangle with specified width and height
...
function encodeToRot13(str) {
  ...
  str.split('').forEach((char) => {
    const index = abcNorm.indexOf(char);
    strEncode += index === -1 ? char : abcRot13[index];
  });
  return strEncode;
}
 ...
 * Function returns the zero-based index of the specified card in the initial deck above.
 *
 * @param {string} value
 * @return {number}
 *
